...
/**
 * <p>
 * A <code>KnowledgeMiner</code> deploys a document retrieval system to search
 * an unstructured knowledge source, e.g. Google to search the World Wide
 * Web.</p>
 *
 * <p>
 ...
 *
 * <p>
 * This class extends the class <code>Searcher</code> and is abstract.</p>
 *
...
public abstract class KnowledgeMiner extends Searcher {
    ...
    /**
     * <p>
     * Sets the query, the hit position of the first result and the number of
     * results to be fetched and starts the thread.</p>
     *
     * <p>
     * This method should be used instead of the inherited <code>start()</code>
     * method without arguments.</p>
     *
    ...
    /**
     * <p>
     * Returns a new instance of the <code>KnowledgeMiner</code>. A new instance
     * is created for each query.</p>
     *
     * <p>
     * It does not necessarily return an exact copy of the current instance.</p>
     *
    ...
    /**
     * <p>
     * Creates <code>[MAX_RESULTS_TOTAL / MAX_RESULTS_PERQUERY]</code> threads
     * that fetch up to <code>MAX_RESULTS_TOTAL</code> results.</p>
     *
     * <p>
     * This method should be used instead of the inherited <code>start()</code>
     * method without arguments.</p>
